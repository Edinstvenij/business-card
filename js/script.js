$(document).ready(function () {
  ...
  let arrLang = {
    ...
    'ru': {
      ...
      'mySurname': 'Виговский',
      'myName': 'Юрий',
      'myAboutMe': 'Веб разработчик',
      'myYears': '19 лет, Одесса',
      // О себе
      'aboutTitle': 'О себе',
      'aboutP1': "Привет, я Юрий —  Веб разработчик  из Одессы. Интересуюсь разработкой и всем, что с ним связано.",
      'aboutP2': 'Закончил курсы от WAYUP по верстке.',
